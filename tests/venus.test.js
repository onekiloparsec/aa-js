import { constants, juliandays, times, Venus } from '../src'
...
describe('venus', () => {
  ...
  test.skip('check apparent equatorial coordinates of Venus', () => {
    ...
    expect(coords.rightAscension.toNumber() * constants.H2DEG).toBeCloseTo(41.73129, 4)
    expect(coords.declination.toNumber()).toBeCloseTo(18.44092, 4)
  })
})
