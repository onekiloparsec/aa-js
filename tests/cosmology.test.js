...
describe('cosmology', () => {
  ...
  test('get angular size scale (kpc/")', () => {
    expect(cosmology.getAngularSizeScale(69.6, 0.286, 0.714, 0)).toEqual(0)
    expect(cosmology.getAngularSizeScale(69.6, 0.286, 0.714, 0.1)).toBeCloseTo(1.857, 1)
    expect(cosmology.getAngularSizeScale(69.6, 0.286, 0.714, 1)).toBeCloseTo(8.122, 1)
    expect(cosmology.getAngularSizeScale(69.6, 0.286, 0.714, 2)).toBeCloseTo(8.521, 1)
    expect(cosmology.getAngularSizeScale(69.6, 0.286, 0.714, 3)).toBeCloseTo(7.855, 1)
    expect(cosmology.getAngularSizeScale(69.6, 0.286, 0.714, 10)).toBeCloseTo(4.255, 1)
    expect(cosmology.getAngularSizeScale(69.6, 0.286, 0.714, 100)).toBeCloseTo(0.619, 1)
    expect(cosmology.getAngularSizeScale(69.6, 0.286, 0.714, 1000)).toBeCloseTo(0.067, 2)
  })
