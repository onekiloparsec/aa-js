import { Degree, EquatorialCoordinates, GeographicCoordinates, LengthArray } from '@/js/types'
import { DEG2RAD, STANDARD_ALTITUDE_STARS } from '@/js/constants'
import { fmod180, fmod360 } from '@/js/utils'
